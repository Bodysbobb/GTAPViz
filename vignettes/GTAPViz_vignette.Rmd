...
<div class="tip-box">
💡 <strong>Tip:</strong> To customize sorting for additional columns, manual adjustments may be required. 
</div>
...
<div class="info-box">
# **Essential Info** {#essential-info .unnumbered}
...
```
</div> <figcaption class="package-fig"> Comparison Plot Visualization <br> </figcaption> </figure>
...
```
</div> <figcaption class="package-fig"> GTAP Macro Plot Visualization <br> <span class="package-fig-note">(splt_by = FALSE)</span> </figcaption> </figure>
...
```
</div> <figcaption class="package-fig"> Detail Plot Visualization <br> <span class="package-fig-note">(top_impact = NULL, invert_pane = TRUE)</span> </figcaption> </figure>
...
**Note:** 
The column names must be `"old"` and `"new"`. See `<?HARplus::rename_col>` for details.  
