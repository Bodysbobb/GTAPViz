...
<p> To simplify modifications and maintain structured code, a printing function is provided. This function displays available options, allowing you to adjust and apply a custom plot style across all plot functions.  

Use the following code to create and apply your own plot style:  <p>
```{r, eval = FALSE}
