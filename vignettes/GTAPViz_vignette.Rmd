---
title: 'GTAPViz: Visualizing GTAP Results from HAR and SL4 Files'
...
output:
  html_document:
    ...
    self_contained: true
vignette: >
  %\VignetteIndexEntry{GTAPViz: Visualizing GTAP Results from HAR and SL4 Files}
...
```
</div> <figcaption class="package-fig"> Detail Plot Visualization <br> <span class="package-fig-note">(top_impact = NULL, invert_pane = TRUE, panel_rows = 1)</span> </figcaption> </figure>
...
```
</div> <figcaption class="package-fig"> Detail Plot Visualization (filtered) <br> <span class="package-fig-note">(top_impact = 10, invert_pane = TRUE)</span> </figcaption> </figure>
...
One of the most powerful features of GTAPViz is the ability to create interactive Excel pivot tables directly from your simulation results. This functionality, provided through the `pivot_table_with_filter()` function, allows you to:

- Convert your processed data into a dynamic Excel pivot table
- Apply filters, rows, and column dimensions interactively
- Modify the aggregation and visualization after export
- Share results with colleagues who might not use R
