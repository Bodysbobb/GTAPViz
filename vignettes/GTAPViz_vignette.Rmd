...
<div class="tip-box">
💡 <strong>Tip:</strong> The <a href="https://github.com/Bodysbobb/GTAPViz/tree/main/inst/extdata/map">mapping file</a> is crucial to correctly format your outputs.
</div>
...
## Setting Up Sub-Directories {#sec:subdirectory}
...
<div class="tip-box">
💡 <strong>Tip:</strong> The process of extracting data in automation can be modified freely. See <code>?auto_gtap_data</code>. Keep in mind that the plot function may require slight modifications to suit the new format.
</div>
...
# **<span style="color:#D62728;">Essential Info</span>** {.unnumbered}

## **<span style="color:#D62728;">Understanding the Function</span>** {.unnumbered}  
...
## **<span style="color:#D62728;">Customizing the Plot</span>** {.unnumbered}
