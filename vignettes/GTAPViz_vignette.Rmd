...
<div class="tip-box">
💡 <strong>Tip:</strong> To customize sorting for additional columns, see `?sort_plot_data`. 
</div>
...
```
</div> <figcaption class="package-fig"> Example of Sorting Figures <br> </figcaption> </figure>
...
<div class="tip-box">
💡 <strong>Tip 1:</strong> The process used in <code>?auto_gtap_data</code> can be modified for both `.sl4` and `.har`, which might be easier for some datasets, such as non-GTAP variables. Keep in mind that the plot function may require slight modifications to suit the new format
</div>

<div class="tip-box">
💡 <strong>Tip 2:</strong> For manual data extraction, see [Manual Data Processing](#sec:manualdata).
</div>
...
<div class="info-box">
# **Essential Information for Visualization** {#essential-info-figure .unnumbered}
...
<div class="info-box">
# **Essential Information for the Reporting Table** {#essential-info-table .unnumbered}
