...
# <span style="color:#003366; font-weight: bold;">Input Data Preparation</span> {#sec:input-preparation}
...
💡 **Tip:**
By default you might not need to define as much as the previous sample code assumed that you follow all the previous instruction, you may use the following commade to get the exact same output:
