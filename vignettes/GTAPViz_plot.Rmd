...
Before generating any figures, it is useful to review the function arguments to ensure you take full advantage of the available customization options. See:

```{r Before Plotting, eval = FALSE}
?comparison_plot
